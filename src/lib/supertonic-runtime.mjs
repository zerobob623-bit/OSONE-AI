// Código de inferência derivado do exemplo Node.js oficial do Supertonic 3.
// Copyright (c) 2026 Supertone Inc. — licença MIT.
// Fonte: https://github.com/supertone-inc/supertonic/tree/main/nodejs
import fs from 'fs';
