    ...
    <AnimatePresence>
      {open && (
        <motion.div className="fixed inset-0 z-[180] bg-black/85 backdrop-blur-xl p-4 overflow-y-auto" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
          <motion.div className="relative max-w-6xl mx-auto my-6 rounded-[2rem] border border-white/10 bg-[#080b12] shadow-2xl overflow-hidden" initial={{ y: 24, scale: .98 }} animate={{ y: 0, scale: 1 }} exit={{ y: 24, scale: .98 }}>
