...
- **Plano de Ações do Agente (`lib/planoDeAcoes.ts`, `lib/esperarTela.ts`)**: o agente executa uma sequência inteira de passos no computador sozinho, sem consultar o usuário a cada etapa (ferramenta `executar_plano_no_pc`).
